...
law_L5L5 = cv2.createLinearFilter(cv2.CV_32F, cv2.CV_32F, kernel=maskDict["L5L5"].astype(np.float32))
law_L5E5 = cv2.createLinearFilter(cv2.CV_32F, cv2.CV_32F, kernel=maskDict["L5E5"].astype(np.float32))
law_L5S5 = cv2.createLinearFilter(cv2.CV_32F, cv2.CV_32F, kernel=maskDict["L5S5"].astype(np.float32))
law_E5E5 = cv2.createLinearFilter(cv2.CV_32F, cv2.CV_32F, kernel=maskDict["E5E5"].astype(np.float32))
law_E5S5 = cv2.createLinearFilter(cv2.CV_32F, cv2.CV_32F, kernel=maskDict["E5S5"].astype(np.float32))
law_S5S5 = cv2.createLinearFilter(cv2.CV_32F, cv2.CV_32F, kernel=maskDict["S5S5"].astype(np.float32))
