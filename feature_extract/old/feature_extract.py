...
# Config Parameter
feature_config = {
    'SLIDE_ROWS': 1,        # slide row
    'SLIDE_COLS': 1,        # slide column
...
if __name__ == '__main__':
    folder_path = '/home/lab/Documents/Peng/safe-IL/airsim_data/2021_Jan_16_20_10_42/'

    files_list1 = glob.glob(os.path.join(folder_path, 'color', '*.jpg'))
    files_list2 = glob.glob(os.path.join(folder_path, 'depth', '*.jpg'))
    files_list1.sort()
    files_list2.sort()
    ...
    result = np.zeros((len(files_list1), a.get_size()))
